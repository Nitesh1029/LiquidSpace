...
export const SearchDrawer = ({
  ...
  function areLocationsEqual(loc1:number, loc2:num) {
    const threshold = 0.0001; 
    return (
      Math.abs(loc1.lat - loc2.lat) < threshold &&
      Math.abs(loc1.long - loc2.long) < threshold
    );
  }
                ...
                <Button
                  ...
                  variant={
                    selectedLocations.some((selectedLoc) =>
                      areLocationsEqual(selectedLoc, { lat: location.lat, long: location.long })
                    )
                      ? 'default'
                      : 'outline'
                  }
