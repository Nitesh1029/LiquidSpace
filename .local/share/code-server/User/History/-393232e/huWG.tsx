...
const RadioButtonsMulti: React.FC<RadioGroupProps> = (props) => {
  ...
  const handleRadioSelected = useCallback(
    async (
      ...
      if (selectedOptions?.includes(fieldName)) {
        newSelectedOptions = selectedOptions.filter((value) => value != fieldName);
      } else {
        newSelectedOptions = [...selectedOptions, fieldName];
      }
  ...
  return (
    ...
    >
      ...
      <Button onClick={handleRadioChange}/>
