...
const RadioButtonsMulti: React.FC<RadioGroupProps> = (props) => {
  ...
  return (
    ...
    >
            ...
            return options.map((option) => {
              return (
                <Flex
                  ...
                  boxShadow={selectedOptions.includes(option.value)?'0px 3px 10px -2px hsla(150, 5%, 65%, 0.5)':null}
                  minWidth={100}
                >
                  <input
                    type="radio"
                    ...
                    onClick={(e) => handleRadioSelected(e)}
                  />
                  <label
      ...
      <Button onClick={(e) => handleRadioChange(e, name)} />
